...
const castleItems = [
    { id: 'vip_7d', name: '👑 VIP (7 dias)', price: 50, currency: 'nox', type: 'vip', days: 7, description: 'Energia max 40, +50% XP/gold, +10 inv' },
    { id: 'vip_30d', name: '👑 VIP (30 dias)', price: 150, currency: 'nox', type: 'vip', days: 30, description: 'Energia max 40, +50% XP/gold, +10 inv' }
];
